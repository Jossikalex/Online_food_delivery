...
<div class="manager-container">
  <aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="manager_application.php"><i class="fas fa-file-alt"></i><span>Application</span></a></li>
  ...
  <div class="main-content">
    ...
    <div class="content-area">
      <div style="display:flex; justify-content:center"><h2>Manager Overview</h2></div>
